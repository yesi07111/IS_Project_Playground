...
public static class Seeder
{
    ...
    public static async Task AddSeeds(this IServiceProvider serviceProvider)
    {
        ...
        var activityDates = new List<ActivityDate>
        {
            ...
            new() { Activity = activities[0], DateTime = AddRandomTime(fiveDaysAgo), ReservedPlaces = 20 },
            new() { Activity = activities[0], DateTime = AddRandomTime(nextMonday), ReservedPlaces = 12 },
            new() { Activity = activities[1], DateTime = AddRandomTime(eightDaysAgo), ReservedPlaces = 17 },
            new() { Activity = activities[1], DateTime = AddRandomTime(nextTuesday), ReservedPlaces = 14 },
            new() { Activity = activities[2], DateTime = AddRandomTime(twelveDaysAgo), ReservedPlaces = 9 },
            new() { Activity = activities[2], DateTime = AddRandomTime(nextWednesday), ReservedPlaces = 11 },

            // Piscina (Capacidad Máxima: 30)
            new() { Activity = activities[3], DateTime = AddRandomTime(eighteenDaysAgo), ReservedPlaces = 30 },
            new() { Activity = activities[3], DateTime = AddRandomTime(nextThursday), ReservedPlaces = 18 },
            new() { Activity = activities[4], DateTime = AddRandomTime(twentyFiveDaysAgo), ReservedPlaces = 28 },
            new() { Activity = activities[4], DateTime = AddRandomTime(nextFriday), ReservedPlaces = 19 },
            new() { Activity = activities[5], DateTime = AddRandomTime(tenDaysAgo), ReservedPlaces = 26 },
            new() { Activity = activities[5], DateTime = AddRandomTime(nextSaturday), ReservedPlaces = 17 },

            // Carrusel (Capacidad Máxima: 15)
            new() { Activity = activities[6], DateTime = AddRandomTime(fifteenDaysAgo), ReservedPlaces = 13 },
            new() { Activity = activities[6], DateTime = AddRandomTime(nextSunday), ReservedPlaces = 15 },
            new() { Activity = activities[7], DateTime = AddRandomTime(twentyDaysAgo), ReservedPlaces = 15 },
            new() { Activity = activities[7], DateTime = AddRandomTime(nextMondayPlusOneWeek), ReservedPlaces = 12 },
            new() { Activity = activities[8], DateTime = AddRandomTime(eightDaysAgo), ReservedPlaces = 10 },
            new() { Activity = activities[8], DateTime = AddRandomTime(nextTuesday), ReservedPlaces = 11 },

            // Laboratorio de Ciencias (Capacidad Máxima: 25)
            new() { Activity = activities[9], DateTime = AddRandomTime(twelveDaysAgo), ReservedPlaces = 18 },
            new() { Activity = activities[9], DateTime = AddRandomTime(nextWednesday), ReservedPlaces = 20 },
            new() { Activity = activities[10], DateTime = AddRandomTime(fiveDaysAgo), ReservedPlaces = 22 },
            new() { Activity = activities[10], DateTime = AddRandomTime(twelveDaysAgo), ReservedPlaces = 23 },
            new() { Activity = activities[10], DateTime = AddRandomTime(nextThursday), ReservedPlaces = 21 },
            new() { Activity = activities[11], DateTime = AddRandomTime(eighteenDaysAgo), ReservedPlaces = 19 },
            new() { Activity = activities[11], DateTime = AddRandomTime(nextFriday), ReservedPlaces = 17 },

            // Estudio de Danza (Capacidad Máxima: 20)
            new() { Activity = activities[12], DateTime = AddRandomTime(twentyFiveDaysAgo), ReservedPlaces = 14 },
            new() { Activity = activities[12], DateTime = AddRandomTime(nextSaturday), ReservedPlaces = 16 },
            new() { Activity = activities[13], DateTime = AddRandomTime(tenDaysAgo), ReservedPlaces = 15 },
            new() { Activity = activities[13], DateTime = AddRandomTime(tomorrow), ReservedPlaces = 13 },
            new() { Activity = activities[14], DateTime = AddRandomTime(fifteenDaysAgo), ReservedPlaces = 12 },
            new() { Activity = activities[14], DateTime = AddRandomTime(nextMondayPlusOneWeek), ReservedPlaces = 14 },

            // Sala de Música (Capacidad Máxima: 15)
            new() { Activity = activities[15], DateTime = AddRandomTime(twentyDaysAgo), ReservedPlaces = 11 },
            new() { Activity = activities[15], DateTime = AddRandomTime(nextMonday), ReservedPlaces = 13 },
            new() { Activity = activities[16], DateTime = AddRandomTime(eightDaysAgo), ReservedPlaces = 10 },
            new() { Activity = activities[16], DateTime = AddRandomTime(nextTuesday), ReservedPlaces = 12 },
            new() { Activity = activities[17], DateTime = AddRandomTime(twelveDaysAgo), ReservedPlaces = 9 },
            new() { Activity = activities[17], DateTime = AddRandomTime(nextWednesday), ReservedPlaces = 11 },

            // Gimnasio (Capacidad Máxima: 50)
            new() { Activity = activities[18], DateTime = AddRandomTime(fiveDaysAgo), ReservedPlaces = 30 },
            new() { Activity = activities[18], DateTime = AddRandomTime(nextThursday), ReservedPlaces = 38 },
            new() { Activity = activities[19], DateTime = AddRandomTime(eighteenDaysAgo), ReservedPlaces = 32 },
            new() { Activity = activities[19], DateTime = AddRandomTime(nextFriday), ReservedPlaces = 19 },
            new() { Activity = activities[20], DateTime = AddRandomTime(twentyFiveDaysAgo), ReservedPlaces = 49 },
            new() { Activity = activities[20], DateTime = AddRandomTime(nextSaturday), ReservedPlaces = 17 },

            // Biblioteca (Capacidad Máxima: 40)
            new() { Activity = activities[21], DateTime = AddRandomTime(tenDaysAgo), ReservedPlaces = 33 },
            new() { Activity = activities[21], DateTime = AddRandomTime(nextSunday), ReservedPlaces = 15 },
            new() { Activity = activities[22], DateTime = AddRandomTime(fifteenDaysAgo), ReservedPlaces = 34 },
            new() { Activity = activities[22], DateTime = AddRandomTime(nextMondayPlusOneWeek), ReservedPlaces = 12 },
            new() { Activity = activities[23], DateTime = AddRandomTime(twentyDaysAgo), ReservedPlaces = 40 },
            new() { Activity = activities[23], DateTime = AddRandomTime(nextMonday), ReservedPlaces = 11 },

            // Cafetería (Capacidad Máxima: 60)
            new() { Activity = activities[24], DateTime = AddRandomTime(eightDaysAgo), ReservedPlaces = 58 },
            new() { Activity = activities[24], DateTime = AddRandomTime(nextTuesday), ReservedPlaces = 20 },
            new() { Activity = activities[25], DateTime = AddRandomTime(twelveDaysAgo), ReservedPlaces = 52 },
            new() { Activity = activities[25], DateTime = AddRandomTime(nextWednesday), ReservedPlaces = 21 },
            new() { Activity = activities[26], DateTime = AddRandomTime(fiveDaysAgo), ReservedPlaces = 59 },
            new() { Activity = activities[26], DateTime = AddRandomTime(nextThursday), ReservedPlaces = 17 },

            // Zona de Juegos Acuáticos (Capacidad Máxima: 25)
            new() { Activity = activities[27], DateTime = AddRandomTime(eighteenDaysAgo), ReservedPlaces = 19 },
            new() { Activity = activities[27], DateTime = AddRandomTime(nextFriday), ReservedPlaces = 16 },
            new() { Activity = activities[28], DateTime = AddRandomTime(twentyFiveDaysAgo), ReservedPlaces = 25 },
            new() { Activity = activities[28], DateTime = AddRandomTime(nextSaturday), ReservedPlaces = 13 },
            new() { Activity = activities[29], DateTime = AddRandomTime(tenDaysAgo), ReservedPlaces = 17 },
            new() { Activity = activities[29], DateTime = AddRandomTime(nextSunday), ReservedPlaces = 14 },

            // Parque de Aventuras (Capacidad Máxima: 30)
            new() { Activity = activities[30], DateTime = AddRandomTime(fifteenDaysAgo), ReservedPlaces = 30 },
            new() { Activity = activities[30], DateTime = AddRandomTime(nextMondayPlusOneWeek), ReservedPlaces = 13 },
            new() { Activity = activities[31], DateTime = AddRandomTime(twentyDaysAgo), ReservedPlaces = 27 },
            new() { Activity = activities[31], DateTime = AddRandomTime(nextMonday), ReservedPlaces = 12 },
            new() { Activity = activities[32], DateTime = AddRandomTime(eightDaysAgo), ReservedPlaces = 29 },
            new() { Activity = activities[32], DateTime = AddRandomTime(nextTuesday), ReservedPlaces = 7 },

            // Mini Zoológico (Capacidad Máxima: 20)
            new() { Activity = activities[33], DateTime = AddRandomTime(twelveDaysAgo), ReservedPlaces = 20 },
            new() { Activity = activities[33], DateTime = AddRandomTime(nextWednesday), ReservedPlaces = 18 },
            new() { Activity = activities[34], DateTime = AddRandomTime(fiveDaysAgo), ReservedPlaces = 20 },
            new() { Activity = activities[34], DateTime = AddRandomTime(nextThursday), ReservedPlaces = 7 },
            new() { Activity = activities[35], DateTime = AddRandomTime(eighteenDaysAgo), ReservedPlaces = 19 },
            new() { Activity = activities[35], DateTime = AddRandomTime(nextFriday), ReservedPlaces = 17 }
        };
        ...
        System.Console.WriteLine("End Seeder");
    }
